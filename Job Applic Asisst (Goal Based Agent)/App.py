...
# To run this app, Activate your virtual environment and run the following command in the terminal:
# Important: venv activate ka sahi flow

# Agar .venv parent folder mein hai, to pehle activate karo:

# cd C:\Users\temporary account\Desktop\Agentic AI Projects
# .venv\Scripts\activate

# Phir project run karo:

# streamlit run .\Job_Application_Assistant\Assis.py
